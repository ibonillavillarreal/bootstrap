<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCatalog.master" AutoEventWireup="true" CodeBehind="NuevosPrestamos.aspx.cs" Inherits="Acciona.Reportes.NuevosPrestamos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cntTitulo" runat="server">
    <div role="navigation" class="">
        ...
        <div class="row">
            ...
            <a href="#" class="navbar-brand">Reporte de Creditos Pyme</a>
        </div>
        <!-- Collection of nav links, forms, and other content for toggling -->
        <div class="row" style="margin-bottom: 5px; margin-top: 5px;">
            <div class="col-md-4">
                <div class="input-group" style="width: 80%;">
                    <span class="input-group-addon" style="width: 150px">Promotor:</span>
                    <asp:DropDownList ID="ddlPromotor" runat="server" CssClass="form-control required input-sm" Width="100%">
                    </asp:DropDownList>
                </div>
            </div>
    ...
    <div class="container">
        <asp:Panel ID="pnlReporte" runat="server" Visible="false">
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
                <LocalReport ReportPath="Reportes\rldc\NuevosCreditos.rdlc">
                </LocalReport>
            </rsweb:ReportViewer>
        </asp:Panel>
    </div>
