<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCatalog.master" AutoEventWireup="true" CodeBehind="Profesiones.aspx.cs" Inherits="Acciona.Catalogos.Profesiones" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cntCuerpo" runat="server">
    ...
    <asp:GridView ID="gvDatos" SkinID="sGridPrincipal" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="IdProfesion" EmptyDataText="No se encontró ninguna profesión registrada" DataMember="Profesion">
        <Columns>
            <asp:BoundField DataField="IdProfesion" HeaderText="IdProfesion" Visible="False" />
