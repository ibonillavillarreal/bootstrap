<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCatalog.master" AutoEventWireup="true" CodeBehind="Creditos.aspx.cs" Inherits="Acciona.Pagos.Creditos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntEncabezado" runat="server">
    ...
    <div class="row" style="margin-bottom: 5px; margin-top: 5px;">
        <div class="col-md-2">
            <div class="input-group" style="width: 100%;">
                <span class="input-group-addon " style="width: 60px">Tipo de Transaccion:</span>
                <asp:DropDownList ID="ddlTipoTransaccion" runat="server" CssClass="form-control "></asp:DropDownList>
            </div>
        </div>
    </div>
    <div class="row" style="margin-bottom: 5px; margin-top: 5px;">
...
<asp:Content ID="Content3" ContentPlaceHolderID="cntCuerpo" runat="server">
    ...
    <div class="container">
        ...
        <asp:GridView ID="gvDetalle" SkinID="sGridPrincipal" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="IdMovimiento"
            EmptyDataText="No se encontró ningun dato registrado" DataMember="vwDatosVehiculos" ShowFooter="True" Caption="Detalle de Vehiculos"
